...
@section('content')
<div>
<img src="{{ asset('Image/contact.jpg') }}" alt="copyright" style="width:93.5%; height:400px; margin-left: 40px;margin-top: 60px;" /> 
</div>
...
<form action="/feedback" method="post" class="forms" 
style="
color: white;
        padding: 20px;
        width: 87%;">
...
<div id="map" class="map_contact" style="height: 464px; width: 600px;margin-top:25px;"></div>
</div>
